                        ...
                        <div class="col-lg-7 mx-auto">
                            <div class="card mt-2 mx-auto p-4 bg-light">
                                <div class="card-body bg-light">
                                    <form action="" method="post" id="enrollment-form" role="form" autocomplete="off">
                                        @csrf
                                        <div class="controls">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="form_enroll_no" type="text" name="enroll_no" class="form-control" placeholder="Enter Enrollment Number *" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="form_join_date" type="date" name="join_date" class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input id="form_fee" type="number" name="fee" class="form-control" placeholder="Enter Fee Amount *" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
